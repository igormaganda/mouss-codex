...
export default function SmartRoadmapGenerator() {
  ...
  const handleExport = useCallback(() => {
    ...
    let text = ''
    text += '╔══════════════════════════════════════════════════════════╗\n'
    text += '║           FEUILLE DE ROUTE SMART — Echo Entreprendre            ║\n'
    text += '╚══════════════════════════════════════════════════════════╝\n\n'
    ...
    text += `Généré par Echo Entreprendre — ${new Date().toLocaleDateString('fr-FR')}\n`
          ...
          <Card className="shadow-sm bg-muted/30">
            <CardContent className="py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-muted-foreground">
              ...
              <span className="text-xs">
                Feuille de route générée par Echo Entreprendre — {new Date().toLocaleDateString('fr-FR')}
              </span>
            </CardContent>
          </Card>
        </div>
